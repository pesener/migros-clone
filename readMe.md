![](images/migros1.png)
With this project, I was aiming to clone the most famous supermarket's (Migros) website in Turkey by using TypeScript, React, Redux, TailwindCss, Node.js , MongoDB.
