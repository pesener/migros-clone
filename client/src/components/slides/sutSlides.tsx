...
const SutSlides = () => {
  ...
  return (
    <div className="w-[1070px] h-[205px]  m-auto relative z-0 group border-none outline-none">
      ...
      {/* rigth arrow */}
      <div className="absolute z-10 flex items-center justify-center  top-[50%] translate-x-[56%] h-8 w-16 translate-y-[-50%] right-5 bg-white   rounded-tl-full rounded-tr-full  rotate-[270deg]  text-gray-600 cursor-pointer shadow-lg">
      ...
      <div className="flex top-0 justify-center py-2 cursor-pointer ">
        {slides.map((slide, slideIndex) => (
          ...
          >
            <div className="h-[5px] w-[13px] rounded"></div>
          </div>
        ))}{" "}
      </div>
    </div>
