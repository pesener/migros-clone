...
const Adress = () => {
  ...
  return (
    <div className="bg-white flex overflow-hidden   mt-2  w-full">
      <div
        onClick={handleClick}
        className="w-[268px] flex ml-32 h-[54px] border-l border-t border-b border-gray-300  mt-3 rounded-l-lg  cursor-pointer"
      >
        <img
      ...
      <div className="w-60 flex h-[54px] mt-3   ml-0 border-t border-r border-b border-gray-300  rounded-tr-lg rounded-br-lg  cursor-pointer">
